...
\begin{figure}
    ...
    \end{subfigure}
    \begin{subfigure}{.4\textwidth}
        \includegraphics[width=\textwidht]{../assets/surg/tactile.jpg}
...
\tightlist
\item
  Epidermis: basal layer contains stem cells from which the epidermis
  can regenerate
\item
  Dermis:
...
\item
  ...
  \tightlist
  \item
    Most are within dermis. Epidermis only contains free nerve endings
    and Merkel cells.
  \item
...
\item
  ...
  \end{itemize}
\item
  Blanch on pressure (as dermal capillaries are mostly unscathed)
\item
  Painful (irritation of free nerve endings)
\item
  Pinprick sensation intact
\item
  Heal without scarring in 2 wks
\end{itemize}
...
\item
  May blister
\item
  Less/no blanching (as dermal capillaries have been burnt)
\item
  Sensation reduced; unable to distinguish fine and crude touch
\item
  Heal with hypertrophic scarring and contractures so need grafting
\end{itemize}
...
\item
  No blanching
\item
  Completely anaesthetised (nerve endings have been burnt off)
\item
