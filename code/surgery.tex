...
\begin{document}
\frontmatter
\includepdf[pages=1,fitpaper]{../pdfs/cover-surgery.pdf}
\maketitle
...
arranged somewhat at random, reflecting the order in which I studied
these before my finals. These notes are, first and foremost, for my
personal use, so pardon the inconvenience. There's probably plenty of
mistakes, all my own. \textbf{Use at your own peril.}
