...
- PBF: full range of granulocytic precursors, from _myeloblasts_ to _mature
 neutrophils_. Predominant: neutrophils and myelocytes. Myeloblasts < 10%.
- Bone marrow examination
- Chromosome analysis to detect Ph chromosome

### Management
#### Chronic phase
- **1st line: Tyrosine kinase inhibitors (TKIs):** normalise blood count
 within a month, complete cytogenetic response (disappearance of Ph chr)
 within 6 months in 90% patients. Resample bone marrow at 6mo to confirm.
 Thereafter monitor 3-monthly by RT-PCR for BCR-ABL mRNA transcripts.
	- **Imatinib**
	- **Dasatinib**
	- **Nilotinib**
