...
- **Parts of the waveform:** fig. \ref{fig:jvp}
	- **a wave**: Atrial systole
		- Giant "cannon" a wave: CHB (AV dissociation $\rightarrow$
		 ...
		 $\rightarrow\;\uparrow\uparrow$ pressure $\rightarrow$ giant a wave)
		- Large a wave: pulmonary htn, PS
		- Absent a wave: AF
	- **c wave:** Atrial relaxation coinciding with ventricular systole
	 (before closure of the tricuspid valve)
	- **x descent:** Atrial relaxation coinciding with ventricular systole
	 (after closure of the tricuspid valve)
	...
	- **y descent:** Atrial emptying
		- During atrial systole, two opposing forces are at play. Atrial
		 ...
		 lowers it.  During the initial part of systole, the contraction
		 is weaker, so the emptying effect takes the lead, giving rise
		 to the _y descent_. Later, the contraction effect is stronger than
		 the emptying effect, and so there's a peak (_a wave_).
...
- **JVP vs carotid pulse**
	- JVP biphasic (2 peaks within each cardiac cycle, one during atrial
	 systole, other during atrial diastole), carotid monophasic (peak only
...
- $\uparrow$JVP
- Kussmaul's sign
- Venous congestion $\rightarrow$ hepatomegaly, ascites, peripheral oedema
- Pulsus paradoxus
