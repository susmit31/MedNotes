...
\hypertarget{chronic-kidney-disease-ckd}{%
\section{Chronic kidney disease
(CKD)}\label{chronic-kidney-disease-ckd}}
...
\begin{tabular}{l m{5cm} c m{5cm}}
    ...
    1 & GFR $\ge$ 90 mL/min/1.73m$^2$ with evidence of kidney damage &
    ...
    4 & GFR 15-29 & Severe CKD & First symptoms often at GFR < 20.
     Electrolyte disorders. \\
    5 & GFR < 15 & Kidney failure & Significant symptoms and complications.
     Dialysis initiated if < 10. \\
...
\tightlist
\item
  \emph{Bone} (\textbf{renal osteodystrophy})
...
\item
  ...
  \item
    Arrhythmias
  \item
    Pericardial tamponade \(\rightarrow\;\;\uparrow\) JVP, pulsus
    paradoxus
  \end{itemize}
\item
  \emph{Respiratory}
...
\tightlist
\item
  \textbf{Monitoring} renal function
  ...
  \end{itemize}
\item
  \textbf{Reducing rate of progression}

  \begin{itemize}
  \tightlist
  \item
    \textbf{Antihypertensive} therapy: Slows rate of decline
  ...
  \item
    ...
    \item
      ...
      \item
        ...
        renal perfusion, so may exacerbate, e.g., pre-renal AKI. So
        should be warned to stop taking the meds if fever, diarrhoea,
  ...
  \end{itemize}
\item
  \textbf{Treatment of complications}
  ...
  \item
    ...
    \tightlist
    \item
      \textbf{Limit protein intake}, especially in stages 4 and 5, as
      urea will accumulate.
    \item
