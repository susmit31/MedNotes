...
\item
  ...
  \item
    ...
    tighter
  \item
    \textbf{Mesangial cells:}

    \begin{itemize}
    \tightlist
    \item
      contract and relax to control capillary diameter \(\rightarrow\)
      blood flow \(\rightarrow\) GFR
    \end{itemize}
  \end{itemize}
\item
  \textbf{Renal tubules}
...
\tightlist
\item
  \textbf{Macula densa} around the distal tubules

  \begin{itemize}
  \tightlist
  \item
    Sense Na concentration in distal tubule filtrate, controlling the
    ...
    \item
      If high GFR, make adenosine from ATP \(\rightarrow\) adenosine
      binds to receptors on afferent arteriole \(\rightarrow\) afferent
      arteriolar constriction \(\rightarrow\) \(\downarrow\)GFR

      \begin{itemize}
      \tightlist
      \item
        As an aside, this is the mechanism behind the mild diuresis
        produced by caffeine. Adenosine carries the signal for tiredness
        in the brain, and caffeine blocks adenosine receptors. In the
        brain, the blocking means you feel less tired. In the afferent
        arterioles, blocking means you can't reduce your GFR.
      \end{itemize}
    \item
