...
\tightlist
\item
  \textbf{1st line: Tyrosine kinase inhibitors (TKIs):} normalise blood
  count within a month, complete cytogenetic response (disappearance of
  Ph chr) within 6 months in 90\% patients. Resample bone marrow at 6mo
  to confirm. Thereafter monitor 3-monthly by RT-PCR for BCR-ABL mRNA
  transcripts.
