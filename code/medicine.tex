...
\section[Nephrotic syndrome]{Nephrotic syndrome\footnote{Most parts of this section, unless specifically
 mentioned to be for membranous nephropathy, refers to minimal change
 disease i.e. (most cases of) paediatric nephrotic syndrome}}
...
\hypertarget{genetic-renal-diseases}{%
\section{Genetic renal diseases}\label{genetic-renal-diseases}}

\hypertarget{alports-syndrome}{%
\subsection{Alport's syndrome}\label{alports-syndrome}}
...
\item
  ...
  \tightlist
  \item
    There's a much rarer (1:20k) autosomal recessive PKD (ARPKD)
  \end{itemize}
\item
  Prevalence 1:1000
\item
