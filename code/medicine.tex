...
\tightlist
\item
  \textbf{RCA} \(\rightarrow\) rt atrium, rt ventricle, SA node (in 60\%
  individuals), AV node (90\%)
...
\end{tabular}\caption{ECG leads and arteries involved according to anatomical location of infarct}
