...
\hypertarget{conduction-system}{%
\subsection{Conduction system}\label{conduction-system}}
...
\tightlist
\item
  Spontaneous depolarization = \emph{pacemaker potential}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\textwidth]{../assets/med/sa-node-ap.jpg}
    \vspace{4mm}
    \caption{SA node action potential}
\end{figure}
...
\item
  Further details: table \ref{table:infarct-loc} and section
  \ref{ssec:coronary}
\end{itemize}
