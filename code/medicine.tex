...
\item
  PBF: full range of granulocytic precursors, from \emph{myeloblasts} to
  \emph{mature neutrophils}. Predominant: neutrophils and myelocytes.
  Myeloblasts \textless{} 10\%.
\item
  Bone marrow examination: hypercellular marrow with increased myeloid
  precursors
\item
