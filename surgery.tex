...
\subsection{\texorpdfstring{\(\blacksquare\) SIRS (Systemic inflammatory
response
...
\subsection{\texorpdfstring{\(\blacksquare\) MODS (Multiple organ
dysfunction
...
\subsection{\texorpdfstring{\(\blacksquare\) MSOF (Multiple system organ
...
\subsection{Management principles}\label{management-principles}}
