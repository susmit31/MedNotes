...
\item
  ...
  \item
    \$\textgreater\$70\% reduction of diameter (i.e.~\textgreater90\%
    reduction of cross-sec) =\textgreater{} severe
  \end{itemize}
\end{itemize}
...
\tightlist
\item
  \$\textgreater\$50\% stenosis of the left coronary artery
  (``\emph{left main stem}'')
\item
  \$\textgreater\$50\% stenosis of the proximal \emph{LAD}
\item
